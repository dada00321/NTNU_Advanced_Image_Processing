...
class MainWindow(QWidget):
	...
	def open_noise_window(self):
		...
		self.noise_window.confirm_signal.connect(self.confirmation_received)
		self.noise_window.show()

	def confirmation_received(self):
		#print("Confirmation received from Window `NoiseGenerateWindow`!")
	...
	def initUI(self):
		...
		sub_layout_2.addWidget(btn_genNoise, 1000, Qt.AlignLeft)
